  ...
  return (
    <html lang="vi" suppressHydrationWarning>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,600;0,700;1,400;1,600&family=Outfit:wght@300;400;500;600&family=Cormorant+Garamond:ital,wght@0,400;0,600;1,400&family=Cinzel:wght@400;600&family=Lato:wght@300;400;700&family=Raleway:wght@300;400;500;600&family=Noto+Serif+Display:wght@400;600&family=Noto+Sans:wght@400;500&display=swap"
          rel="stylesheet"
        />
      </head>
